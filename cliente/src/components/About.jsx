...
const About = () => {
  ...
  return (
    <div className="w-[100%] py-[40px] md:py-[120px] md:mx-auto md:flex md:flex-col px-[20px] md:px-[4%] overflow-x-hidden bg-[#161616] md:bg-[#111]">
