...
const Carasterist = () => {
  ...
  return (
    <div className="w-screen px-[25px] md:px-[5%] md:py-[130px] pb-[40px] flex flex-col md:flex-row items-center md:items-stretch justify-center md:gap-10 bg-[rgb(220,220,220)] md:bg-[#080808]">
        {
            data.map((box,i) => (
                <div key={i} className="w-[100%] md:w-[29%] mb-[45px] md:py-[20px] md:px-[20px] md:mb-0 md:bg-[rgb(240,240,240)] md:rounded-md md:border md:border-[#222]" data-aos="fade-left">
