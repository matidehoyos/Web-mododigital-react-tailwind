...
const Carasterist = () => {
  ...
  return (
    <div className="w-screen px-[25px] xl:px-[5%] xl:py-[130px] pb-[40px] flex flex-col xl:flex-row items-center xl:items-stretch justify-center xl:gap-10 bg-[rgb(220,220,220)] xl:bg-[#080808]">
        {
            data.map((box,i) => (
                <div key={i} className="w-[100%] xl:w-[29%] mb-[45px] xl:py-[20px] xl:px-[20px] xl:mb-0 xl:bg-[rgb(240,240,240)] xl:rounded-md xl:border xl:border-[#222]">
