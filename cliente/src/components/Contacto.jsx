  ...
  return (
    <div id='contacto' className="w-screen py-[120px] md:py-[80px] px-[20px] overflow-x-hidden bg-[#fff]" >
          ...
          <div className='flex justify-center'>
                  <a href="https://api.whatsapp.com/send?phone=542236901801" target='blank' className="botom mt-[32px] md:mt-10 py-[6px] md:py-[8px] px-[12px] md:px-[16px] bg-azul-900 text-[16px] md:text-[20px] font-[600] tracking-[.3px] drop-shadow border border-azul-900 rounded-[4px] shadow-xl shadow-[#45a4ad72] xl:hover:bg-azul-900 xl:hover:text-white" data-aos="fade-up" data-aos-duration="800">
                    Contáctanos
                  </a>
           </div>
    </div>
