  ...
  return (
    <div class="w-screen py-[70px] xl:py-[120px] px-[20px] overflow-x-hidden bg-[rgb(245,245,245)] ">
          ...
          <div className='flex justify-center'>
                  <a href="https://api.whatsapp.com/send?phone=542236901801" target='blank' className="botom mt-[32px] xl:mt-16 py-[6px] xl:py-[8px] px-[12px] xl:px-[16px] text-azul-900 text-[14px] xl:text-[20px] font-[600] tracking-[.3px] drop-shadow border border-azul-900 rounded-[6px] shadow-xl shadow-[#45a5ad98] xl:hover:bg-azul-900 xl:hover:text-white">
                    Contáctanos
                  </a>
           </div>
    </div>
