...
const Ecommerce = () => {
  ...
  return (
    <div className='w-[100%] pt-[50px] md:pt-[25px] pb-16 px-[15px] md:px-[20px] bg-[rgb(20,20,20)] md:bg-[#222]'>
    ...
    <ul class="mt-1 pt-3 list-none text-[18px] font-[300] drop-shadow text-gray-400 tracking-[.5px] leading-tight border-t border-white border-opacity-10" data-aos="fade-right" data-aos-duration="800">
      ...
      <li class="flex items-baseline mb-[1px] md:font-[500]"><FaCheck class="mr-1 md:mr-2 text-verde-900 text-[10px] md:text-[14px]" />Métodos de pago en línea.</li>
      <li class="flex items-baseline mb-[1px] md:font-[500]"><FaCheck class="mr-1 md:mr-2 text-verde-900 text-[10px] md:text-[14px]" />Aplicación de carrito de compras.</li>
      <li class="flex items-baseline mb-[1px] md:font-[500]"><FaCheck class="mr-1 md:mr-2 text-verde-900 text-[10px] md:text-[14px]" />Botón a Whatsapp y redes sociales.</li>
      ...
      <li class="flex items-baseline mb-[1px] md:font-[500]"><FaCheck class="mr-1 md:mr-2 text-verde-900 text-[10px] md:text-[14px]" />Sección rewiews de clientes.</li>
      ...
      <li class="flex items-baseline mb-[1px] md:font-[500]"><FaCheck class="mr-1 md:mr-2 text-verde-900 text-[10px] md:text-[14px]" />Adaptada a todos los tamaños y dispositivos.</li>
