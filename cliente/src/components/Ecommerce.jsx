...
const Ecommerce = () => {
  return (
    <div className='w-screen py-16 px-[15px] bg-gray-600'>
    ...
    <ul class="mt-1 pt-4 list-none text-[16px] font-semibold drop-shadow text-slate-200 opacity-80 tracking-tight border-t border-white border-opacity-60">
