...
const Header = () => {
  return (
<div class="bg-[url('../../public/bg.png')] bg-bottom bg-cover min-h-screen w-screen pt-20">
    <p className='font-semibold tracking-[.03em] text-white text-center text-xl drop-shadow-md w-80 m-auto leading-5'>¿Buscas un sitio web que represente a tu negocio?</p>
    ...
    <button className='p-0 w-auto mt-20 mx-36 -tracking-tight rouded-md'><a href='' className='bg-red-500 opacity-80 py-2 px-2 rounded-md shadow-2xl shadow-red-900'>Comencemos</a></button>
    </div>
  );
};
