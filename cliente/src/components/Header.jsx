...
const Header = () => {
  ...
  return (
        <div className="bg-[url('/bg7.jpg')] bg-cover bg-center bg-no-repeat h-[100vh] w-screen">
                ...
                <button className='p-[10px] z-50 bg-[#111] fixed bottom-[26px] right-[10px] rounded-[50%] border border-azul-900'><a href="https://api.whatsapp.com/send?phone=542236901801" target="_blank" rel="noopener noreferrer"><FaWhatsapp className='text-[32px] text-azul-900'/></a></button>
