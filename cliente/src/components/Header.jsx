...
const Header = () => {
  ...
  return (
        <div className="bg-[url('/bg7.jpg')] bg-cover bg-center bg-no-repeat xl:bg-[url('/bgxl.jpeg')] xl:bg-bottom xl:bg-fixed h-[100vh] xl:h-[900px] xl:pb-[120px] w-screen">
                ...
                <p className='m-auto pt-[80px] md:pt-[100px] xl:pt-[120px] tracking-[0.3px] text-[rgb(190,190,190)] opacity-95 text-center text-[16px] md:text-[22px] xl:text-[24px] font-montserrat font-[600] italic' data-aos="fade-up" data-aos-duration="800">¿Buscas un sitio web a tu medida?</p>
                ...
                <p className='w-[92%] mt-20 md:mt-[140px] xl:mt-[140px] mx-auto p-2 text-pretty text-center text-[rgb(180,180,180)] opacity-95 text-[18px] md:text-[22px] xl:text-[23px] font-[600] tracking-[.3px] leading-[25px] font-montserrat italic' data-aos="fade-up" data-aos-duration="800">Prestigio, jerarquía y credibilidad para tu negocio.</p>
