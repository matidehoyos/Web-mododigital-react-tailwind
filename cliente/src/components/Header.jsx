...
const Header = () => {
  return (
        <div class="bg-[url('/bg2.jpeg')] bg-bottom bg-cover h-auto w-screen pt-16 pb-36">
                ...
                <h1 className='w-[70%] mx-auto text-center text-white opacity-95 font-montserrat text-5xl tracking-tight leading-10 drop-shadow-md'>Diseño web <br/>profesional</h1>
