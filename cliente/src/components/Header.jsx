...
const Header = () => {
  return (
        <div class="bg-[url('/bg2.jpeg')] bg-bottom bg-cover h-auto w-screen pt-24 pb-20">
                <p className='w-80 m-auto tracking-[0.4px] text-slate-400 text-center text-[22px] font-semibold drop-shadow-sm leading-6'>¿Buscas un sitio web de categoria para tu negocio?</p>
