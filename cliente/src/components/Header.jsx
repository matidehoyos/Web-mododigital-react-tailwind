...
const Header = () => {
  return (
        <div class="bg-[url('/bg1.jpeg')] bg-bottom bg-cover h-auto w-screen pt-16 pb-28">
                ...
                <p className='w-4/5 mt-14 mx-auto text-pretty text-center text-slate-200 font-montserrat text-xl font-bold drop-shadow-md leading-6'>Sumale prestigio, jerarquia y posicionamiento a tu negocio con un software hecho a su medida.</p>
