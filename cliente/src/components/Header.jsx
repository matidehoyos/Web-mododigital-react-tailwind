...
const Header = () => {
  return (
        <div className="bg-[url('../../public/bg5.jpeg')] bg-cover h-auto w-screen pt-24 pb-36">
                <p className='w-auto m-auto tracking-[0.4px] text-[#fff] opacity-75 text-center text-[18px] font-bold drop-shadow-sm'>¿Buscas un sitio web de categoria?</p>
