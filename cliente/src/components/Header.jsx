...
const Header = () => {
  return (
<div class="bg-[url('./bg.png')] bg-bottom bg-cover min-h-screen w-screen pt-20">
    <p className='font-semibold tracking-[.03em] text-center text-xl drop-shadow-md w-80 m-auto leading-5'>¿Buscas un sitio web que represente a tu negocio?</p>
