...
const Header = () => {
  return (
        <div className="bg-[url('/bgg.jpeg')] bg-cover h-[100vh] w-screen">
                <p className='m-auto pt-[90px] tracking-[0.3px] text-gray-300 text-center text-[18px] font-montserrat font-[400] italic'>¿Buscas una web a tu medida?</p>
