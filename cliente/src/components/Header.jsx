  ...
  return (
        <div className="bg-[url('/bg7.jpg')] bg-cover bg-center bg-no-repeat xl:bg-[url('/bgxl.jpeg')] xl:bg-bottom xl:bg-fixed h-[100vh] xl:h-[900px] xl:pb-[120px] w-screen">
                ...
                <div className="flex justify-center">
                  <a href="#tipos" className="botom mt-12 py-[6px] px-[14px] text-azul-900 text-[16px] md:text-[18px] font-[600] tracking-[.3px] drop-shadow border border-azul-900 rounded-[6px]" data-aos="fade-up" data-aos-duration="800" >
                    Comencemos
                  </a>
                </div>
        </div>
