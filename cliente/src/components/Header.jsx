...
const Header = () => {
  return (
        <div class="bg-[url('/bg4.jpeg')] bg-cover h-auto w-screen pt-24 pb-20">
                <p className='w-[70%] m-auto tracking-[0.4px] text-slate-300 text-center text-[20px] font-semibold drop-shadow-sm leading-6 break-keep'>¿Buscas un sitio web de categoria para tu negocio?</p>
