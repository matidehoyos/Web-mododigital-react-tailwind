...
const Header = () => {
  return (
        <div className="bg-[url('/bg.jpeg')] bg-cover bg-top h-auto w-screen py-[100px]">
                ...
                <p className='w-[82%] mt-32 mx-auto text-pretty text-center text-white opacity-70 drop-shadow text-[20px] font-semibold leading-[24px]'>Dale prestigio y credibilidad a tu negocio con un sitio a su medida.</p>
        </div>
  );
};
