...
const Header = () => {
  ...
  return (
        <div className="bg-[url('/bg7.jpg')] bg-cover bg-center bg-no-repeat xl:bg-[url('/bgxl.jpeg')] xl:bg-bottom xl:bg-fixed h-[100vh] xl:h-[900px] xl:pb-[120px] w-screen">
                <div className='w-screen h-[100vh] xl:h-[900px] bg-black bg-opacity-80 xl:bg-opacity-65 blur-sm xl:blur-lg absolute overflow-hidden' data-aos="fade-down" data-aos-duration="3000" data-aos-easing="ease-in-sine"></div>
