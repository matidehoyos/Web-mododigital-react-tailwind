...
const Portfolio = () => {
  return (
    <div class="w-screen py-16 px-[15px] pb-[100px] overflow-x-hidden bg-[#1c3133]">
          ...
          <h4 className=' mt-[12px] text-[20px] text-[#b9b9b9] tracking-wide leading-[21px] font-[600]'>PORTFOLIOS<br/><span className='text-[#548589] text-[17px] leading-none'>para profesionales</span></h4>
