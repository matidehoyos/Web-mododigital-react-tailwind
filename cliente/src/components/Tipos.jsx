  ...
  return (
    <div class="w-screen pt-[40px] bg-white">
        ...
        <div className='w-screen py-16 px-[15px]'>
              ...
              <p className='text-[18px] text-black opacity-80 font-bold'>Que incluye?</p>
              <ul class="mt-1 pt-4 list-none text-[18px] font-semibold drop-shadow text-black opacity-90 tracking-tight border-t border-black border-opacity-60">
