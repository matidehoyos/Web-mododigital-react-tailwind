...
const Tipos = () => {
  return (
    <div class="w-screen py-[50px] bg-white">
        ...
        <div className='w-screen flex-col pt-[40px]'>
            <div className='w-[84%] mx-auto mb-10 py-[4px] pl-[12px] pb-4 flex-col justify-start items-start bg-verde-900 bg-opacity-30 rounded-sm'>
            ...
            <div className='w-[84%] mx-auto mb-10 py-[4px] pl-[20px] pb-4 flex-col justify-start items-start bg-verde-900 bg-opacity-30 rounded-sm'>
            ...
            <div className='w-[84%] mx-auto py-[40px] rounded-sm border'>
                <h3 className='text-[26px] tracking-wide leading-[42px] font-[800] text-center text-gray-700 drop-shadow border'>BLOGS</h3>
                <h3 className='text-[26px] tracking-wide leading-[42px] font-[800] text-center  text-gray-700 drop-shadow border'>PORTFOLIOS</h3>
                <h3 className='text-[26px] tracking-wide leading-[42px] font-[800] text-center text-gray-700 drop-shadow border'>SOCIAL WEBS</h3>
            </div>
        </div>
    </div>
  );
